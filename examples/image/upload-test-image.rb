...
image_service = Fog::Image::HuaweiCloud.new :huaweicloud_api_key => ENV['OS_PASSWORD'],
                                          :huaweicloud_username => ENV["OS_USERNAME"],
                                          :huaweicloud_auth_url => ENV["OS_AUTH_URL"] + "/tokens",
                                          :huaweicloud_tenant => ENV["OS_TENANT_NAME"]
