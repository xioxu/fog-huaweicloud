...
module Fog
  module Volume
    class HuaweiCloud
      class V2 < Fog::Volume::HuaweiCloud
        ...
        model_path 'fog/volume/huaweicloud/v2/models'
        ...
        request_path 'fog/volume/huaweicloud/v2/requests'
        ...
        class Real
          ...
          def initialize(options = {})
            ...
            @huaweicloud_service_type  = options[:huaweicloud_service_type] || ['volumev2']
