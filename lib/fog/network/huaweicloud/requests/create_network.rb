  ...
  module Network
    class HuaweiCloud
      class Real
        ...
        #
        # Not strictly required but commonly found in HuaweiCloud
        ...
        # Map Fog::Network::HuaweiCloud::Network
        # model attributes to HuaweiCloud provider attributes
        ALIASES = {
      ...
      class Mock
        def create_network(options = {})
          ...
          data.merge!(Fog::Network::HuaweiCloud::Real.create(options))
