  ...
  module Network
    class HuaweiCloud < Fog::Service
      ...
      recognizes :huaweicloud_auth_token, :huaweicloud_management_url,
                 ...
                 :huaweicloud_identity_prefix, :huaweicloud_path, :huaweicloud_version

      ## MODELS
      #
      model_path 'fog/network/huaweicloud/models'
      model       :extension
      ...
      ## REQUESTS
      #
      request_path 'fog/network/huaweicloud/requests'
      ...
      class Mock
        ...
        def data
          self.class.data["#{@huaweicloud_username}-#{@huaweicloud_tenant}"]
        end

        def reset_data
          self.class.data.delete("#{@huaweicloud_username}-#{@huaweicloud_tenant}")
        end
      end
