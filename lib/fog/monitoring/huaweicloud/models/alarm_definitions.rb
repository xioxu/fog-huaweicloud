...
require 'fog/monitoring/huaweicloud/models/alarm_definition'

module Fog
  module Monitoring
    class HuaweiCloud
      class AlarmDefinitions < Fog::HuaweiCloud::Collection
        model Fog::Monitoring::HuaweiCloud::AlarmDefinition
        ...
        def find_by_id(id)
          ...
          Fog::Monitoring::HuaweiCloud::AlarmDefinition.new(
