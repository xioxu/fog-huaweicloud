  ...
  module SharedFileSystem
    class HuaweiCloud < Fog::Service
      ...
      recognizes :huaweicloud_auth_token, :huaweicloud_management_url,
                 ...
                 :huaweicloud_identity_prefix, :huaweicloud_shared_file_system_microversion

      model_path 'fog/shared_file_system/huaweicloud/models'
      model       :network
      collection  :networks
      model       :share
      collection  :shares
      ...
      request_path 'fog/shared_file_system/huaweicloud/requests'
      # share networks
      ...
      class Real
        ...
        def self.not_found_class
          Fog::SharedFileSystem::HuaweiCloud::NotFound
        end

        def initialize(options = {})
          @supported_versions     = SUPPORTED_VERSIONS
          @supported_microversion = SUPPORTED_MICROVERSION
          @fixed_microversion     = options[:huaweicloud_shared_file_system_microversion]
          @microversion_key       = 'X-Openstack-Manila-Api-Version'.freeze

          initialize_identity options

          @huaweicloud_service_type  = options[:huaweicloud_service_type] || ['sharev2']
