module Fog
  module Compute
    class HuaweiCloud
      ...
      class Mock
        def create_security_group(name, description)
          Fog::Identity::HuaweiCloud.new(:huaweicloud_auth_url => credentials[:huaweicloud_auth_url])
          tenant_id = Fog::Identity::HuaweiCloud::V2::Mock.data[current_tenant][:tenants].keys.first
