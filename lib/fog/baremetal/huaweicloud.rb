...
module Fog
  module Baremetal
    class HuaweiCloud < Fog::Service
      ...
      ## MODELS
      #
      model_path 'fog/baremetal/huaweicloud/models'
      model       :chassis
      ...
      ## REQUESTS
      #
      request_path 'fog/baremetal/huaweicloud/requests'
      ...
      class Real
        ...
        #   Fog::Baremetal::HuaweiCloud::NotFound
        # end

        def initialize(options = {})
          initialize_identity options

          @huaweicloud_service_type  = options[:huaweicloud_service_type] || ['baremetal']
        ...
        def set_api_path
          unless @path.match(SUPPORTED_VERSIONS)
            @path = "/" + Fog::HuaweiCloud.get_supported_version(SUPPORTED_VERSIONS,
