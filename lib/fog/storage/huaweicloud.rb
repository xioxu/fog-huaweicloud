  ...
  module Storage
    class HuaweiCloud < Fog::Service
      ...
      recognizes :huaweicloud_auth_token, :huaweicloud_management_url,
                 ...
                 :huaweicloud_project_name, :huaweicloud_project_id, :huaweicloud_cache_ttl,
                 ...
                 :huaweicloud_identity_prefix, :huaweicloud_temp_url_key

      model_path 'fog/storage/huaweicloud/models'
      model       :directory
      collection  :directories
      model       :file
      collection  :files

      request_path 'fog/storage/huaweicloud/requests'
      request :copy_object
      ...
      class Mock
        ...
        def initialize(options = {})
          ...
          @huaweicloud_management_url = options[:huaweicloud_management_url] || 'http://example:8774/v2/AUTH_1234'
      ...
      class Real
        ...
        def self.not_found_class
          Fog::Storage::HuaweiCloud::NotFound
        end
        ...
        def initialize(options = {})
          ...
          @huaweicloud_service_type           = options[:huaweicloud_service_type] || ['object-store']
        ...
        #     service = Fog::Storage[:huaweicloud]
