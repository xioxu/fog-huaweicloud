...
require 'fog/storage/huaweicloud/models/file'

module Fog
  module Storage
    class HuaweiCloud
      class Files < Fog::HuaweiCloud::Collection
        attribute :directory
        attribute :limit
        attribute :marker
        attribute :path
        ...
        model Fog::Storage::HuaweiCloud::File
        ...
        def get_url(key)
          ...
          if directory.public_url
            "#{directory.public_url}/#{Fog::HuaweiCloud.escape(key, '/')}"
          end
        end
