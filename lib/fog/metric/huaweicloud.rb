module Fog
  module Metric
    class HuaweiCloud < Fog::Service
      ...
      model_path 'fog/metric/huaweicloud/models'
      ...
      request_path 'fog/metric/huaweicloud/requests'
      ...
      class Real
        ...
        def self.not_found_class
          Fog::Metric::HuaweiCloud::NotFound
        end

        def initialize(options = {})
          initialize_identity options

          @huaweicloud_service_type           = options[:huaweicloud_service_type] || ['metric']
