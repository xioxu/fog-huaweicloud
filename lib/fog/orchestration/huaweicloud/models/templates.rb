...
require 'fog/orchestration/huaweicloud/models/template'

module Fog
  module Orchestration
    class HuaweiCloud
      class Templates < Fog::HuaweiCloud::Collection
        model Fog::Orchestration::HuaweiCloud::Template
        ...
        def get(obj)
          ...
          new(data)
        rescue Fog::Orchestration::HuaweiCloud::NotFound
          nil
        end
