...
require 'fog/identity/huaweicloud/v2/models/ec2_credential'

module Fog
  module Identity
    class HuaweiCloud
      class V2
        class Ec2Credentials < Fog::HuaweiCloud::Collection
          model Fog::Identity::HuaweiCloud::V2::Ec2Credential
          ...
          def find_by_access_key(access_key)
            ...
            unless ec2_credential
              ...
              ec2_credential = Fog::Identity::HuaweiCloud::V2::EC2Credential.new(body)
            end
