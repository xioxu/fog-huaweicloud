...
module Fog
  module Metering
    class HuaweiCloud < Fog::Service
      ...
      model_path 'fog/metering/huaweicloud/models'
      ...
      request_path 'fog/metering/huaweicloud/requests'
      ...
      class Real
        ...
        def self.not_found_class
          Fog::Metering::HuaweiCloud::NotFound
        end

        def initialize(options = {})
          initialize_identity options

          @huaweicloud_service_type           = options[:huaweicloud_service_type] || ['metering']
