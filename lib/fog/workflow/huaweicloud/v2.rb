  ...
  module Workflow
    class HuaweiCloud
      class V2 < Fog::Service
        ...
        recognizes :huaweicloud_username, :huaweicloud_api_key,
                   :huaweicloud_project_name, :huaweicloud_domain_id

        ## REQUESTS
        #
        request_path 'fog/workflow/huaweicloud/v2/requests'
        ...
        class Real
          ...
          def initialize(options = {})
            ...
            @huaweicloud_service_type  = options[:huaweicloud_service_type] || ['workflowv2']
          ...
          def request(params)
            ...
            raise case error
                  when Excon::Errors::NotFound
                    Fog::Workflow::HuaweiCloud::NotFound.slurp(error)
                  else
                    error
                  end
          else
